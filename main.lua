...
function love.update(dt)
    ...
    -- 1. Game over -> ask for name once
    if stage.game_over and not leaderboard_handled then
        enteringName = true
        love.keyboard.setTextInput(true)
        leaderboard_handled = true
    end
...
function love.draw()
    ...
    if stage.game_over then
        ...
        if enteringName then
            ...
            love.graphics.printf(playerName, 0, love.graphics.getHeight() / 2, love.graphics.getWidth(), "center")
